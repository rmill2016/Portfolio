...
export type Query = {
  ...
  /** Returns the single instance record */
  servicespage?: Maybe<ServicespageRecord>;
...
export type ServicecardModelBodyField = {
  __typename?: 'ServicecardModelBodyField';
  blocks: Array<Scalars['String']>;
  links: Array<Scalars['String']>;
  value: Scalars['JsonField'];
};

/** Block of type ServiceCard (servicecard) */
export type ServicecardRecord = RecordInterface & {
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']>;
  _updatedAt: Scalars['DateTime'];
  body?: Maybe<ServicecardModelBodyField>;
  id: Scalars['ItemId'];
  title?: Maybe<Scalars['String']>;
};
...
export type ServicesmessageModelTextField = {
  __typename?: 'ServicesmessageModelTextField';
  blocks: Array<Scalars['String']>;
  links: Array<Scalars['String']>;
  value: Scalars['JsonField'];
};

/** Block of type ServicesMessage (servicesmessage) */
export type ServicesmessageRecord = RecordInterface & {
  __typename?: 'ServicesmessageRecord';
  _createdAt: Scalars['DateTime'];
  _firstPublishedAt?: Maybe<Scalars['DateTime']>;
  _isValid: Scalars['BooleanType'];
  _modelApiKey: Scalars['String'];
  ...
  text?: Maybe<ServicesmessageModelTextField>;
};


/** Block of type ServicesMessage (servicesmessage) */
export type ServicesmessageRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};

/** Record of type ServicesPage (servicespage) */
export type ServicespageRecord = RecordInterface & {
  __typename?: 'ServicespageRecord';
  _createdAt: Scalars['DateTime'];
  _firstPublishedAt?: Maybe<Scalars['DateTime']>;
  _isValid: Scalars['BooleanType'];
  _modelApiKey: Scalars['String'];
  ...
  _unpublishingScheduledAt?: Maybe<Scalars['DateTime']>;
  _updatedAt: Scalars['DateTime'];
  cards: Array<ServicecardRecord>;
  header?: Maybe<HeaderRecord>;
  id: Scalars['ItemId'];
  link?: Maybe<LinkRecord>;
  servicesmessage: Array<ServicesmessageRecord>;
  skills: Array<SkillRecord>;
  skillstitle?: Maybe<Scalars['String']>;
  techstack: Array<TechstackRecord>;
  techstacktitle?: Maybe<Scalars['String']>;
  title?: Maybe<Scalars['String']>;
};


/** Record of type ServicesPage (servicespage) */
export type ServicespageRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
...
/** Block of type Skill (skill) */
export type SkillRecord = RecordInterface & {
...
/** Block of type TechStack (techstack) */
...
/** Record of type WorkPage (workpage) */
...
export type WorktileModelDetailsField = {
  __typename?: 'WorktileModelDetailsField';
  blocks: Array<Scalars['String']>;
  links: Array<Scalars['String']>;
  value: Scalars['JsonField'];
};

/** Block of type Project (worktile) */
export type WorktileRecord = RecordInterface & {
  __typename?: 'WorktileRecord';
  _createdAt: Scalars['DateTime'];
  _firstPublishedAt?: Maybe<Scalars['DateTime']>;
  _isValid: Scalars['BooleanType'];
  _modelApiKey: Scalars['String'];
...
/** Block of type Project (worktile) */
export type WorktileRecord_SeoMetaTagsArgs = {
  locale?: InputMaybe<SiteLocale>;
};
